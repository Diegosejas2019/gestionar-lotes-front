...
import type { Alert, AlertRule, AuditLog, Buyer, BuyerDashboard, BuyerPortalDocument, BuyerPortalInstallment, BuyerPortalPayment, BuyerPortalProfile, BuyerPortalSaleDetail, BuyerSaleSummary, CashAccount, CashAccountSummaryItem, CashBalanceEvolutionPoint, CashMovement, CommercialFunnelEvolutionPoint, CommunicationLog, CommunicationSettings, CommunicationTemplate, CurrentLegalDocumentsResponse, DashboardOverviewEvolutionPoint, DashboardSummary, DeedProcess, DelinquencyAction, DelinquencyCase, Development, DevelopmentSettings, EffectivePermissions, ExecutiveSummary, Expense, ExpenseByCategoryItem, FinanceDashboardSummary, FinancialAlert, GeneratedDocument, ImportBatch, ImportRow, ImportTemplate, Installment, Lead, LeadActivity, LegalAcceptance, LegalDashboardSummary, LegalDocument, LegalProcess, Lot, LotsMapResponse, LotsMapSummary, MigrationBatch, MigrationExecuteConfig, MigrationItem, MigrationPreviewResult, MigrationStatusResponse, MonthlyIncomeExpensePoint, Notification, OnboardingChecklist, OrganizationSettings, OrganizationSubscription, Payment, PaymentMethodConfig, PaymentRequest, PermissionsCatalogModule, PlanLimits, PlanModules, Quotation, RefinancingAgreement, Reservation, Role, SaasDashboard, Sale, SaleDetail, Supplier, SubscriptionPayment, SubscriptionPlan, UsageInfo, UserRoleAssignment, WorkProgressLog, WorkProject, WorkProjectSummaryItem } from '../types';
...
export const dashboardApi = {
  ...
  overviewEvolution: (params?: Record<string, string>) => apiGet<{ monthlyData: DashboardOverviewEvolutionPoint[] }>('/api/dashboard/overview-evolution', params),
};
...
export const commercialDashboardApi = {
  ...
  funnelEvolution: (params?: Record<string, string>) => apiGet<{ monthlyData: CommercialFunnelEvolutionPoint[] }>('/api/commercial-dashboard/funnel-evolution', params),
